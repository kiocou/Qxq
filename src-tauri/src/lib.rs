...
pub fn run() {
    ...
    let mut app_builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            core::create_floating_toolbar_window,
            core::close_floating_toolbar_window,
            core::set_floating_toolbar_window_rect,
            core::has_floating_toolbar_window,
            core::show_floating_toolbar_window,
            core::hide_floating_toolbar_window,
            core::is_floating_toolbar_visible,
