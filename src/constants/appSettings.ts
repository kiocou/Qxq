...
export const defaultAppSettingsData: AppSettingsData = {
	...
	[AppSettingsGroup.Cache]: {
		...
		floatingToolbarDocked: true,
		floatingToolbarDockSide: "right",
		floatingToolbarY: -1,
		floatingToolbarX: -1,
	},
...
4. Visual structure preservation`,
	...
	[AppSettingsGroup.FunctionOutput]: {
		manualSaveFileNameFormat: `Qxq_{{YYYY-MM-DD_HH-mm-ss}}`,
		autoSaveFileNameFormat: `Qxq_{{YYYY-MM-DD_HH-mm-ss}}`,
		fastSaveFileNameFormat: `Qxq_{{YYYY-MM-DD_HH-mm-ss}}`,
		focusedWindowFileNameFormat: `${FOCUS_WINDOW_APP_NAME_ENV_VARIABLE}/Qxq_{{YYYY-MM-DD_HH-mm-ss}}`,
		fullScreenFileNameFormat: `Qxq_{{YYYY-MM-DD_HH-mm-ss}}`,
		videoRecordFileNameFormat: `Qxq_Video_{{YYYY-MM-DD_HH-mm-ss}}`,
		uploadToCloudSaveUrlFormat: `Qxq_{{YYYY-MM-DD_HH-mm-ss}}`,
	},
