export const zhHant = {
	...
	"home.exit": "退出",
	"floatingToolbar.title": "快速工具列",
	"floatingToolbar.dragToMove": "拖曳移動",
	"floatingToolbar.close": "關閉工具列",
	"floatingToolbar.screenshot": "截圖",
	"floatingToolbar.ocr": "文字辨識",
	"floatingToolbar.translate": "翻譯",
	"floatingToolbar.fixedContent": "釘選到螢幕",
	"floatingToolbar.toggle": "顯示/隱藏快速工具列",
	"floatingToolbar.more": "更多工具",
	"floatingToolbar.settings": "調整",
	"floatingToolbar.resetPosition": "按兩下恢復自動停靠",
	"draw.drag": "拖曳",
	"draw.red": "紅色",
	"draw.orange": "橘色",
	"draw.green": "綠色",
	...
	"common.newVersion.updateReady.description":
		"Qxq {version} 已準備就緒，是否立即重新啟動應用程式進行更新？",
